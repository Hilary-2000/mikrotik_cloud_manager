...
<head>
    ...
    <title>Hypbits - "{{ucwords(strtolower($organization_details->organization_name))}}" View Transactions Details</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">View Transactions <small data-toggle='tooltip' title="Mikrorik Cloud Manager Transaction View" class="badge bg-danger text-sm">MCMTV</small></h4>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <a href="{{route("get_transactions",[$organization_details->organization_id])}}" class="btn btn-infor"><i class="fas fa-arrow-left"></i>
                                        Back to list</a>
                                </div>
