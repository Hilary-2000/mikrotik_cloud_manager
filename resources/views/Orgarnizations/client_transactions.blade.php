...
<head>
    ...
    <title>Hypbits - "{{ucwords(strtolower($organization_details->organization_name))}}" Transactions</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">"{{ucwords(strtolower($organization_details->organization_name))}}" Transactions</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">"{{ucwords(strtolower($organization_details->organization_name))}}" Transactions
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Transaction Table <small data-toggle='tooltip' title="Mikrorik Cloud Manager Transaction View" class="badge bg-danger text-sm">MCMTV</small></h4>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 border border-primary rounded p-1 hide" id="show_generate_reports_window">
                                            ...
                                            <form action="{{route("generate_reports",[$organization_details->organization_id])}}" target="_blank" method="GET">
                                                @csrf
                                                <div class="row">
