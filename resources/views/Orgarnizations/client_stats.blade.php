                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Client On-Boarding Statistics <small data-toggle='tooltip' title="Mikrorik Cloud Manager Client View" class="badge bg-danger text-sm">MCMCV</small></h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <a href="{{url()->previous()}}" class="text-primary"><i class="ft-arrow-left"></i> Back to Clients</a>
                                    {{-- <p>{{($client_data)}}</p> --}}
