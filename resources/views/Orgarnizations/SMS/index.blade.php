...
<head>
    ...
    <title>Hypbits - "{{$organization_details->organization_name}}" SMS</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">"{{$organization_details->organization_name}}" - SMS</h3>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">SMS Table <small data-toggle='tooltip' title="Mikrorik Cloud Manager SMS View" class="badge bg-danger text-sm">MCMSV</small></h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <a href="{{route("ViewOrganization",[$organization_details->organization_id])}}" class="text-primary"><i class="ft-arrow-left"></i> Back to Organization</a>
                                    <div class="container border border-secondary rounded shadow-sm w-100 m-0 my-2 p-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                {{-- <button type="button" id="show_sms_balance_btn" class="btn btn-primary btn-sm d-none">Show Balance</button> --}}
                                                <p class="d-none">Sms Balance: <span></span>: <span id="show_sms_balance">0 SMS</span><small class="text-primary d-none" id="show_sms_loader"> Loading...</small></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @endif
                                    <div class="w-20">
                                        {{-- <a href="{{route("customize_sms", [$organization_details->organization_id])}}" class="btn btn-secondary text-bolder {{$readonly}}">Customize SMS</a> --}}
                                        @php
                                            $btnText = "Customize SMS";
                                            $otherClasses = "text-bolder";
                                            $btnLink = route("customize_sms", [$organization_details->organization_id]);
                                            $otherAttributes = "";
                                            $readonly = "";
                                        @endphp
                                        ...
                                        @php
                                            ...
                                            $type = "button";
                                            $readonly = "";
                                            $otherAttributes = 'data-toggle="tooltip" title="SMS Reports"';
                                        @endphp
                                    ...
                                    <div class="row  my-2">
                                        <div class="col-md-12 border border-primary rounded p-1 hide" id="show_generate_reports_window">
                                            ...
                                            <form action="{{route("generate_reports_sms", [$organization_details->organization_id])}}" target="_blank" method="GET">
                                                {{-- @csrf --}}
                                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="/sms/compose" class="btn btn-info text-bolder d-none float-right {{$readonly}}"><i class="ft-plus"> Write Message</i></a>
                                        </div>
                                    </div>
