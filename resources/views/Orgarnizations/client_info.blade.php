...
<head>
    ...
    <title>Hypbits - {{ucwords(strtolower($organization_details->organization_name))}} Client Details</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">{{ucwords(strtolower($organization_details->organization_name))}} Client`s Detail</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{url()->previous()}}">{{ucwords(strtolower($organization_details->organization_name))}} Clients</a>
                                </li>
                                <li class="breadcrumb-item">"{{ucwords(strtolower($clients_data[0]->client_name))}}"
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 id="view_clients_inform" class="card-title">View <span class="text-secondary">"{{ ucwords(strtolower($clients_data[0]->client_name)) }}"</span> <small data-toggle='tooltip' title="Mikrorik Cloud Manager Client View" class="badge bg-danger text-sm">MCMCV</small></h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form-group" action="{{route("update_client",[$organization_details->organization_id])}}" method="POST">
                                        @csrf
