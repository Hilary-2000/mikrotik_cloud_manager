...
<head>
    ...
    <title>Hypbits - My Orgarnizations</title>
...
@php
    ...
    $readonly = readOnlyOption($priviledges,"My Orgarnizations");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">My Orgarnizations</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">My Orgarnizations
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">My Organizations</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <div class="row">
                                        <div class="col-md-4 form-group row border-right border-dark">
