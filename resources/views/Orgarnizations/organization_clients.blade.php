...
<head>
    ...
    <title>Hypbits - {{$organization_details->organization_name}} - Clients</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title"> {{$organization_details->organization_name}} - Clients</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{$organization_details->organization_name}} - Clients
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="content-body">
                ...
                <div class="row ">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Client Table <small data-toggle='tooltip' title="Mikrorik Cloud Manager Client View" class="badge bg-danger text-sm">MCMCV</small></h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
