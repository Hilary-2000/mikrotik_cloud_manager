...
@php
    ...
    $client_refferal = $clientrefferal;
@endphp
<div class="row">
    <div class="col-md-9">
        <a href='{{route("viewOrganizationClients", $organizationdetails->organization_id)}}' class="btn btn-infor"><i class="fas fa-arrow-left"></i> Back to list</a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="container" method="POST" action="{{route("convertClient", [$organizationdetails->organization_id])}}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="router_list" id="router_list" class="form-control" required>
                            ...
                            <div class="form-group">
                                <label for="pppoe_profile" class="form-control-label">Router Profile: <span class="invisible" id="interface_load_main"><i class="fas ft-rotate-cw fa-spin"></i></span></label>
                        ...
                        <form class="container" method="POST" action="{{route("convertClient", [$organizationdetails->organization_id])}}">
                            ...
                            <div class="form-group">
                                ...
                                <label  id="errorMsg" for="client_network" class="form-control-label">Clients Network
                                    { <span class="primary" id="networks">{{$last_client_details[0]->client_network ?? ""}}</span> }</label>
                            ...
                            <div class="form-group">
                                <label for="client_address" class="form-control-label">Router Interface:
                    ...
                    <div class="row w-100">
                        <div class="col-md-6">
                            @php
                                ...
                                $btnLink = route("delete_user", [$organizationdetails->organization_id, $clients_data[0]->client_id]);
                            @endphp
    ...
    <div class="modal fade text-left hide" style="background-color: rgba(0, 0, 0, 0.5);" id="update_phone_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" style="padding-right: 17px;" aria-modal="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <form action="{{route("change_client_phone", [$organizationdetails->organization_id])}}" method="post" class="form-control-group">
                            @csrf
    ...
    <div class="modal fade text-left hide" style="background-color: rgba(0, 0, 0, 0.5);" id="update_expiration_date_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel4" style="padding-right: 17px;" aria-modal="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <form action="{{route("updateExpDate", [$organizationdetails->organization_id])}}" method="post" class="form-control-group">
                            @csrf
    ...
    <div class="modal fade text-left hide" style="background-color: rgba(0, 0, 0, 0.5);" id="update_monthly_payment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" style="padding-right: 17px;" aria-modal="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <form action="{{route("change_client_monthly_payment", [$organizationdetails->organization_id])}}" method="post" class="form-control-group">
                            @csrf
    ...
    <div class="modal fade text-left hide" style="background-color: rgba(0, 0, 0, 0.5);" id="update_monthly_min_pay_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel6" style="padding-right: 17px;" aria-modal="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <form method="POST" action="{{route("client.update.minimum_payment.static", [$organizationdetails->organization_id])}}" class="form-control-group border border-primary rounded p-1">
                            @csrf
    ...
    <div class="modal fade text-left hide" style="background-color: rgba(0, 0, 0, 0.5);" id="update_wallet_amount_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel7" style="padding-right: 17px;" aria-modal="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <form action="{{route("changeWallet", [$organizationdetails->organization_id])}}" method="post" class="form-control-group">
                            @csrf
                        ...
                        <form action="{{route("set_freeze_date", [$organizationdetails->organization_id])}}" method="post" class="form-control-group border border-primary rounded p-1">
                            ...
                            @if ($clients_data[0]->client_freeze_status == "1" || date("YmdHis") < date("YmdHis",strtotime($clients_data[0]->freeze_date)))
                                @php
                                    ...
                                    $btnLink = route("deactivatefreeze", [$organizationdetails->organization_id, $clients_data[0]->client_id]);
                                @endphp
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="form-control-group">
                            ...
                            <form action="{{route("setRefferal", [$organizationdetails->organization_id])}}" method="post">
                                @csrf
                                <div class="row my-2">
                                    <input type="hidden" name="clients_id"
                                value="{{ $clients_data[0]->client_id }}">
    ...
    <div class="modal fade text-left hide" style="background-color: rgba(0, 0, 0, 0.5);" id="update_comments_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel110" style="padding-right: 17px;" aria-modal="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container">
                        <form action="{{route("update_client_comment", [$organizationdetails->organization_id])}}" method="post" class="form-control-group">
                            @csrf
                ...
                <div class="modal-body">
                    <div class="container">
                        <form action="#" method="post" class="form-control-group">
                            @csrf
                            <h6 class="text-center">Initiate STK Push</h6>
                            <p><b>Note</b> This will only work if we have done M-Pesa Integration</p>
                            <div class="form-group">
                                <input type="hidden" name="organization_id_stkpush" value="{{$organizationdetails->organization_id}}" id="organization_id_stkpush">
...
<div class="container my-2">
    ...
    <table class="table table-bordered mb-0">
                    ...
                    @if ($clients_data[0]->payments_status == 1)
                        <div class="row">
                            ...
                            @php
                                ...
                                $btnLink = route("deactivate_payment", [$organizationdetails->organization_id, $clients_data[0]->client_id]);
                            @endphp
                    ...
                    @else
                        <div class="row">
                            ...
                            @php
                                $btnText = "Activate";
                                $otherClasses = ($clients_data[0]->client_freeze_status == "1" ? "disabled":"")." w-100 my-1";
                                $btnLink = route("activate_payment", [$organizationdetails->organization_id, $clients_data[0]->client_id]);
                            @endphp
                    ...
                    @if ($clients_data[0]->client_status == 1)
                        <div class="row">
                            ...
                            @php
                                $btnText = "De-Activate";
                                $otherClasses = ($clients_data[0]->client_freeze_status == "1" ? "disabled":"")." w-100 my-1";
                                $btnLink = route("deactivate_client", [$organizationdetails->organization_id, $clients_data[0]->client_id]);
                            @endphp
                            <x-button-link :btnText="$btnText" :btnLink="$btnLink" btnType="danger" btnSize="sm" :otherClasses="$otherClasses" :readOnly="$readonly" />
                            <p class="text-success d-none"><b>Activated</b></p></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                @php
                                    ...
                                    $btnLink = route("activate_client", [$organizationdetails->organization_id, $clients_data[0]->client_id]);
                                @endphp
                                <x-button-link :btnText="$btnText" :btnLink="$btnLink" btnType="success" btnSize="sm" :otherClasses="$otherClasses" :readOnly="$readonly" />
        ...
        <tr>
            <td>
                <div class="row">
                    ...
                    <div class="col-sm-6">{{ $registrationdate }}</div>
                </div>
            </td>
            <td>
                <div class="row">
        ...
        <tr>
            <td>
                <div class="row">
                    <div class="col-sm-7"><strong>Expiration Date:</strong> <br>{{isset($expiredate) ? $expiredate : "Null"}}</div>
                    <div class="col-sm-5"> 
                        @php
                            $btnText = "<i class=\"fas fa-pen\"></i> Edit";
                            $otherClasses = "w-100 ".($clients_data[0]->validated == 0 ? "d-none" : "");
