                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header my-0">
                                <a href="{{route("SMS")}}" class="btn btn-infor my-0"><i class="fas fa-arrow-left"></i>
                                    Back to SMS</a>
                                    ...
                                    <div class="card-text">
                                        ...
                                        <div class="row">
                                            <div class="row col-md-6">
                                                ...
                                                <div class="col-md-6  border border-light">
                                                    <p><code>[org_name]</code></p>
                                                </div>
                                                <div class="col-md-6  border border-light">
                                                    <p>2. Organization First Name</p>
                                                </div>
                                                <div class="col-md-6  border border-light">
                                                    <p><code>[org_first_name]</code></p>
                                                </div>
                                                <div class="col-md-6  border border-light">
                                                    <p>3. Address</p>
                                                </div>
                                                <div class="col-md-6  border border-light">
                                                    <p><code>[org_address]</code></p>
                                                </div>
                                                <div class="col-md-6  border border-light">
                                    ...
                                    <section id="html-headings-default" class="row match-height">
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="daybefore_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="deday_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 my-2 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="after_due_date_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                    ...
                                    <section id="html-headings-default" class="row match-height">
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="correct_acc_no_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="incorrect_acc_no_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 shadow col-md-6 my-2 d-none">
                                            <div class="card">
                                                <div class="card-header">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="refferer_message_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 shadow col-md-6 my-2 d-none">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="below_min_amnt_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                    ...
                                    <section id="html-headings-default" class="row match-height">
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="account_renewed_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="account_extended_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 my-2 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="account_deactivated_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                    ...
                                    <section id="html-headings-default" class="row match-height">
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="account_frozen_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="account_unfrozen_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 shadow col-md-6 my-2">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="future_account_freeze_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                    ...
                                    <section id="html-headings-default" class="row match-height">
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="welcome_sms_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                    ...
                                    <section id="html-headings-default" class="row match-height">
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="welcome_client_sms_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 shadow col-md-6">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="rcv_coracc_billsms_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                        ...
                                        <div class="col-sm-12 shadow col-md-6 my-2">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="rcv_incoracc_billsms_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                                            <label for="message_contents_13" class="form-control-label">
                                                                Message Content
                                                            </label>
                                        ...
                                        <div class="col-sm-12 shadow col-md-6 my-2">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="rcv_belowmin_billsms_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
                                                            <label for="message_contents_13" class="form-control-label">
                                                                Message Content
                                                            </label>
                                        ...
                                        <div class="col-sm-12 shadow col-md-6 my-2">
                                            <div class="card">
                                                ...
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form id="msg_reminder_bal_win" class="form-group d-none" action="{{route("save_sms_content")}}" method="post">
                                                            @csrf
