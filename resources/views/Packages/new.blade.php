...
<head>
    ...
    <title>Hypbits - New Packages</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-4 col-12 mb-2">
                    <h3 class="content-header-title">New Packages</h3>
                </div>
                    ...
                    <div class="breadcrumbs-top float-md-right">
                        <div class="breadcrumb-wrapper mr-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">New Packages
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form action="{{url()->route("ProcessNewPackage")}}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input required type="text" name="package_name" id="package_name"
                                                    class="form-control rounded-lg p-1" placeholder="Package name"
                                                    required
                                                    @if (session("package_name"))
                                                        value="{{session("package_name")}}"
                                                    @endif
                                                    >
                                            </div>
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input required type="number" min="0" name="package_amount" id="package_amount"
                                                    ...
                                                    @if (session("package_amount"))
                                                        value="{{session("package_amount")}}"
                                                    @endif>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="w-100 row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input required type="number" name="free_trial_period_number" id="free_trial_period_number"
                                                            class="form-control rounded-lg p-1" placeholder="ex 10"
                                                            required
                                                            @if (session("free_trial_period_number"))
                                                                value="{{session("free_trial_period_number")}}"
                                                            @else
                                                                value="1"
                                                            @endif>
                                                    </div>
