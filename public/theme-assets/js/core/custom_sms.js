...
function replace_text(data) {
    var date = new Date();
    data = data.replace(/\[org_name\]/g, "HypBits Enterprise Limited");
    data = data.replace(/\[org_first_name\]/g, "HypBits");
    data = data.replace(/\[org_address\]/g, "Kisauni Town");
    data = data.replace(/\[exp_date\]/g, "12th Dec 2027 at 12:00:00am");
    data = data.replace(/\[reg_date\]/g, "12th Jan 2027");
    // data = data.replace(/\[int_speeds\]/g, "3M/4M");
    data = data.replace(/\[package_fees\]/g, "Ksh 2000");
