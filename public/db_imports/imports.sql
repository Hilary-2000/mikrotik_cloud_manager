...
CREATE TABLE `sms_tables` (
  ...
  `deleted` int DEFAULT '0',
  PRIMARY KEY (`sms_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19355 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `verification_codes` (
  ...
  `deleted` int DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8574 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;